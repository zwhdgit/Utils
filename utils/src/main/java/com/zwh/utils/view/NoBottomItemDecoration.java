 ...
 */
public class NoBottomItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public NoBottomItemDecoration(Context context, int orientation) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        /**
         * 此处 i < childCount 改为 i < childCount - 1
         */
