 ...
 * -------1、可选最大行数
 * -------2、可选对齐方式
 * -------2、可设置子View横纵向间隔 ，父View默认无外部左右边距
 * -------4、使用adapter模式，无内置监听器，需要请自行添加
 * desc: https://blog.csdn.net/u013107751/article/details/81701606
 */
public class FlowLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //todo RecyclerView Holder复用冲突 ，这里简单处理注调，后续可优化
//        if (changed) {
