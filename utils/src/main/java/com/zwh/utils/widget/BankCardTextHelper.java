...
/**
 * 卡号输入框辅助类，1111 1111 1111
 * 使用方法 BankCardTextHelper.bin
 */
public class BankCardTextHelper implements TextWatcher {
    ...
    public static void bind(EditText editText) {
        new BankCardTextHelper(editText, DEFAULT_MAX_LENGTH);
    }

    public static void bind(EditText editText, int maxLength) {
        new BankCardTextHelper(editText, maxLength);
    }

    public BankCardTextHelper(EditText editText, int maxLength) {
