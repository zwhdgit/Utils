...
public class QQService extends AccessibilityService {
     ...
     * 聊天页面
     */
    private static final String QQ_LAUCHER = " com.tencent.mobileqq.activity.SplashActivity";
    /**
     * 拆包页面
     */
    ...
    static final String ENVELOPE_TEXT = "恭喜发财";
//    static final String ENVELOPE_TEXT_STATUS = "已领取";
    ...
    private void openEnvelope(AccessibilityEvent event) {
        ...
        if (event.getPackageName().equals("com.tencent.mobileqq")) {
            ...
            } else if (QQ_LAUCHER.contentEquals(className)) {
                //在聊天界面,去点中红包
                checkKey2();
            } else {
                checkKey2();
...
//        ClickUtils.INSTANCE.click(this, 600, 1160);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                ClickUtils.INSTANCE.click(QQService.this, 526, 1472);
            }
        }, 100);
    }
...
//        List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByText("领取红包");
        ...
        if (packList.isEmpty()) {
            ...
            for (AccessibilityNodeInfo info : packList) {
                accessibilityUtils.performViewClick(info);
            }
        }
    }
